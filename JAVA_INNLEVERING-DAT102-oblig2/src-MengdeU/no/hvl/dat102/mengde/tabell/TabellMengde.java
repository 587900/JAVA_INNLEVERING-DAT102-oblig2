...
public class TabellMengde<T> implements MengdeADT<T> {
	...
	public TabellMengde() { // Konstrukt√∏r 1
		this(STDK);
	}

	public TabellMengde(int start) { // Konstrukt√∏r 2
		antall = 0;
	...
	/**
	 * Sjekker om input-objekt er identisk med dette objektet. Det mÂ vÊre av typen
